label start:
    ...
    moondog "Your breakfast is served this evening, your Wickedness!"
    ...
    batta "Oh DAISY, my Darling, your clever little fingers are nearly as smart as the Core 2 Duo processor your systems run on..."
    
    show batta normal sultry
    batta "In fact, I should like to see more of the actuators hard at work later this evening, perhaps we could perform a bit of a..."
    
    batta "...{i}stress test{/i} to see what the absolute limits of their functionality might be?"
    
    show daisy flustered
    daisy "My Lady, if I may service-"
    
    show batta normal happy
    batta "Ah, but sadly there's no time to muse over the fine- points of {i}my{/i} engineering prowess now! Not when my hour of triumph is finally so close at hand!"
    ...
    show batta normal maniacal
    batta "A plan so secretive, so {i}lucrative{/i} DAISY-BOT- my Dearest Little Bug- even {i}you{/i} probably can't fathom the depths of my genius {i}DEPRAVITY...{/i}"
    ...
    show daisy exsasperated
    daisy "And what might your wickedly depraved scheme be this time, My Lady-"
    
    show batta normal maniacal
    batta "I'M GLAD YOU ASKED!"
    
    show batta normal happy
    batta "Because I've gone ahead and ordered a gross ton of the most cost- effective explosive devices that Evil Money can buy! All from the most wickedly villainous source of all..."
    
    show batta normal maniacal
    batta "WHAMAZON.COM!!"
    
    show batta normal happy
    batta "And under the cover of night, I'll swoop in, stuff their silly little traveler's packs to the brim, and when morning comes and they go to break their fast, or change out of their jammies-"
    
    show batta normal maniacal
    batta "KABOOM!!!"
    
    batta "They'll be blown to smithereens!!!"
    
    batta "HAHAHAHAHAHAHAHAHAHA!!!"
    ...
    daisy "Apologies, My Lady, it's just..."
    
    daisy "That's it?"
    
    show batta normal shocked
    batta "W- what do you mean, \"that's it\"??"
    
    show daisy sheepish
    daisy "Forgive my insolence, Beloved Countess, but from the way you had been hyping up this plan since yesterday evening, I had expected something a bit less..."
    ...
    batta "Now listen DAISY-BOT, you haven't even heard about the part where I lie to Whamazon.com and claim I never received the package-"
    ...
    show batta normal neutral
    batta "And since when do you have the gall to think you know better than I do?"
    
    show daisy suprised
    daisy "My Lady, that's not-"
    ...
    show batta normal neutral
    batta "Y- you've been talking back too much, DAISY. You need to re- learn your place."
    
    show daisy neutral
    daisy "...yes, My Lady."
    
    batta "You think you know so much about explosives, don't you? Then your task today can be to move the remaining 138 bombs I won't be needing for my Villainous Machinations to the storage room."
    
    show daisy exsasperated
    daisy "...dare I ask why you have purchased so many extra, My Lady? Another part of your plan I couldn't hope to comprehend, perhaps?"
    
    show batta normal embarrassed
    batta "...If you bought a gross, the last two came free..."
    
    show batta normal neutral
    batta "Not that you would know anything about how to run a successful evil dominion, DAISY-BOT. Your CPU couldn't even begin to process the amount of planning, budgeting, and {i}effort{/i} that goes into keeping this place from falling apart!"
    ...
    daisy "Not that I'd ever accuse the Immortal Dark Lord of being so magnanimous as to protect the {i}incredibly volatile materials{/i} he sells with anything more than the cheapest packaging available if it means he could save a few Evil Dollars in the process."
    
    show tulong at right with fastdissolve
    tulong "\"JUST HITCHED\" HEHEHE!"
    
    daisy "Hm?"
    
    tulong "\"JUST HITCHED\"! \"JUST HITCHED\"!"
    ...
    show daisy suprised
    daisy "Oh wow, that is kind of fucked up actually."
    
    show daisy confused
    daisy "What sort of sick freak-"
    
    tulong "JUSTHITCHEDJUSTHITCHEDJUST-"
    ...
    daisy "Rice? Don't tell me all these bombs are just glorified confetti poppers filled with rice?"
    
    show daisy uh oh
    daisy "Wait."
    
    daisy "The rice, that means-"
    
    show minions holding bombs at center with fastdissolve
    minions "COUNT. MUST COUNT-"
    ...
    show minions empty hands
    minions "COUNT THE RICE! MUST COUNT THE RICE!!"
    
    show daisy exsasperated
    daisy "Not again..."
    
    show daisy neutral
    daisy "Lady DeVila will be back not long before dawn."
    
    show daisy exsasperated
    daisy "Unsuccessful, if the explosives she took were anything like these ones..."
    
    show daisy neutral
    daisy "And if I don't get all this rice counted and cleaned up before then, she'll probably spend the next three days straight {i}at least{/i} counting out every last grain until this hallway is spotless."
    ...
    show daisy neutral
    daisy "No. No I'd better get this taken care of, quickly."
    ...
    batta "So there I was- silent under the beckoning cover of nightfall. Graceful. Conniving. In my element."
    ...
    show daisy flustered
    daisy "-and what happened next, My Lady? The Heroes didn't happen to see you, did they?"
    ...
    daisy "My Lady, there was an incident-"
    
    batta "I had to stand there for twenty minutes like a BUFFOON- a peasant child rode by on their tiny tricycle and {i}laughed at me!{/i}"
    
    show daisy exsasperated
    daisy "I had to clean the floor before-"
    
    batta "I couldn't even kill him where he stood because I was too distracted by the {i}feeling of glitter up my-{/i}"
    
    show daisy frustrated
    daisy "Would you like for me to draw you a bath, My Lady?"
    
    batta "No, what I would {i}like{/i} is for you all to do as I say without question! My Minions should answer to {i}me{/i} above all else, not to you! Just wait until I get my hands on-"
    
    show daisy neutral
    daisy "It was my fault, My Lady. I asked them to keep you outside while I took care of the unsightly mess caused by one of the bombs discharging during transportation into storage."
    
    daisy "I accept all responsibility for their actions. You may punish me as you see fit."
    ...
    batta "When I first put you together, when I first {i}gave you life,{/i} you were always so eager to please. My satisfaction was the axis that turned your entire world- the very thought of displeasing me a fate worse than death."
    
    show daisy neutral
    daisy "...that hasn't changed, My Lady."
    ...
    batta "And they will have no idea that it was ME who ordered them there in the first place!"
    ...
    batta "...Did I neglect to mention that the pizzas would also be {i}poisoned?{/i}"
    ...
    show batta relaxed happy
    batta "But rest assured, my Dear Little Iron- filled Delicacy, you may now bask in shock and also {i}awe{/i} at the full glorious scope of my wicked scheme!"
    
    show batta relaxed haughty
    batta "No one can resist a piping hot pizza- especially after they've already paid for it! And once they take a single bite, well let's just say..."
    
    show batta normal maniacal
    batta "...it'll be to DIE FOR!!"
    ...
    show batta normal maniacal
    batta "-it will surely {i}take their breath aw-{/i}"
    
    daisy "My Lady, please do not mistake what I am about to say for a lack of faith in your evil-ness, however..."
    ...
    show batta relaxed happy
    batta "Oh {i}DAISY-BOT,{/i} my Maniacal Little Mechanical Marvel, that's perfect! It's so simple, and yet so {i}dastardly,{/i} the poetic justice-"
    ...
    show batta relaxed haughty
    batta "I mean, of course my creation is sometimes capable of capturing a mere shard of my brilliance. That's precisely what I was plotting to do."
    
    batta "You will inform the Minions at once about {i}my{/i} plan. Then you will continue with your work, DAISY-BOT."
    ...
    show batta normal happy
    batta "Excellent work, my wretched little thralls!"
    
    show daisy confused
    daisy "My Lady? I thought the pizza-"
    
    show batta normal embarrassed
    batta "Yes, well... you and the Minions have been working quite hard these past few days to get this placed cleaned up for the culmination of my vile plans..."
    
    batta "...and I just had the menu in front of me, and I was already ordering the other pizzas, so... as a show of my upmost {i}magnanimousness towards those loyal to my cause-{/i}"
    
    batta "-I may have made an additional order."
    
    show batta normal happy
    batta "Budgetary restrictions begin tomorrow."
    ...
    # A ringtone chimes
    show candlestein texting
    candlestein "Hey Boss, we gotta bit of a problem down here el oh el."
    ...
    daisy "AND APPROXIMATELY 2.5\% PEELED GARLIC CLOVES."
    
    batta "Garlic cloves?!?"
    
    batta "Might this be some kind of botched assassination attempt on the part of Tony's Pizza and Wings?"
    
    show batta normal maniacal
    batta "Count what few bleak days you have left on this Earth, {i}Tony S. Pizza,{/i} because your reckoning will be swift and-"
    ...
    batta "Be sure to take a slice of pizza for yourself once you are done, DAISY. I shall return victorious before dawn."
    ...
    daisy "I suppose I should get started so that I might grab a bite before Tulong comes along and eats whatever's left."
    ...
    show batta relaxed angry
    batta "Well, that explains the whole garlic fiasco then. DAISY-BOT, remind me to never order a pizza from there ever again."
    ...
    show daisy confused
    daisy "Wait a minute, My Lady."
    
    daisy "If the two orders were swapped by mistake, that means the tainted pizzas must have gone to..."
    ...
    show batta normal happy at right with fastdissolve
    batta "Oh! Good evening DAISY, my sweet little hemoglobin- filled handmaid, you're right on time tonight as always~"
    
    daisy "...have you rested well this past day, My Lady? Forgive my forwardness, but you do seem a bit-"
    
    show batta normal maniacal
    batta "-full of good ideas? Brimming with wicked possibility? Absolutely {i}OOZING{/i} with maniacal concepts of destruction and doom?"
    
    show batta normal sultry
    batta "How sweet of you to notice, my Darling Bug~"
    
    show batta normal maniacal
    batta "And THAT is precisely why I have been up since dawn, tirelessly crafting a {i}foolproof{/i} plot to overtake this wretched Kingdom once and for all!"
    ...
    batta "It's {i}always{/i} been you, how could I not have seen it sooner? You were the variable I have been neglecting all this time."
    
    show daisy flustered
    daisy "My Lady, as always, it would be my upmost honor and pleasure to service you this-"
    
    batta "You kept those prototype armor upgrades I tested on you last month, didn't you Darling? Those still holding up well enough?"
    
    daisy "A- armor?!? I'll be needing {i}armor{/i} for this, My Lady?!"
    ...
    show batta normal happy
    batta "Excellent! Those pathetic peacekeepers won't know what struck them until it's already far too late!"
    
    show daisy flustered
    daisy "{i}    In front of the Heroes, My Lady?!?!?{/i}"
    
    batta "Well no, not {i}in front{/i} of them. Otherwise they might make a {i}paltry attempt{/i} to stop us from destroying the church."
    
    show daisy confused
    daisy "...?"
    
    daisy "Destroy the... church, My Lady?"
    ...
    show batta normal maniacal
    batta "And afterwards... well, let's just say those fools haven't got a prayer!"
    ...
    show batta normal embarrassed
    batta "To be quite honest, I spent a majority of the night trying to come up with a better line then that."
    ...
    show batta normal happy
    batta "Oh DAISY, Darling, I'm just so happy to hear you approve-"
    
    daisy "But My Lady... why do you need me for this?"
    
    show batta normal shocked
    batta "..."
    
    show batta normal happy
    batta "Because you are my greatest asset, DAISY-BOT. The most refined weapon in my arsenal."
    
    show batta normal maniacal
    batta "The very PEAK of my 23 days of grueling codeschool.com study!"
    
    batta "..."
    
    show batta normal embarrassed
    batta "I'll admit it- I may have let some {i}minor insecurities{/i} get the better of me this past week."
    
    batta "Watching how the Minions look to you for guidance, how they hang on to your every word..."
    
    batta "...the way you just come up with a diabolical scheme on the spot... or how you can foresee the issues with my own almost before I can even think of them."
    ...
    show batta normal embarrassed
    batta "Okay no, it's absolutely worse, now that I've said it out loud... wow..."
    
    show batta normal happy
    batta "But I can see it now. It's okay that you're so good at all the things you do, DAISY-BOT. It only makes sense."
    
    batta "{i}    I made you that way.{/i}"
    
    batta "There is nothing else for you to be."
    ...
    show batta normal sultry
    batta "-say you will do this {i}with me.{/i} Side- by- side, as a weapon and her Wielder were always meant to be."
    
    show daisy neutral
    daisy "..."
    
    daisy "It would be an honor to assist you with your diabolical scheme, My Creator."
    ...
    show batta normal happy
    batta "-oh, it's almost as if {i}I{/i} get to help {i}you{/i} prepare for the evening for once instead. How fun!"
    ...
    show daisy sheepish
    daisy "...my employer's extensive library collection."
    
    daisy "I was to nervous to come until tonight though, since I was... unsure of what the Goddess' opinion was on robots?"
    ...
    show daisy neutral
    daisy "Thank you for your kind words, Archcleric."
    ...
    show batta normal maniacal
    batta "For those oblivious clergy to have willingly invited in {i}the very instrument of their demise?{/i}"
    
    batta "Now THAT is truly a betrayal with a kiss!!"
    ...
    show daisy neutral
    daisy "What if you get injured? There's enough silver and holy water around to-"
    
    batta "Oh please! As if a few sprinkles of magic water or a couple of cheap baubles are enough to take ME out of commission."
    
    show batta normal neutral
    batta "Have you so little faith in your Mistress' strength?"
    ...
    show batta normal maniacal
    batta "TORCH the relics! OVERTURN the benches! SHATTER THE-"
    
    show batta normal neutral
    batta "DAISY, doesn't it look like those two Saints on that window over there are... kind of giving each other bedroom eyes?"
    
    batta "Their embrace is also a bit..."
    
    show batta normal sultry
    batta "..."
    
    show batta normal maniacal
    batta "SHATTER all the windows, {i}except for that one!{/i}"
    
    batta "THE GODDESS WILL WEEP THIS NIGHT AS HER CHOSEN HEROES LOSE THEIR TEATHER TO HER FONT OF POWER!"
    
    show batta normal happy
    batta "And soon enough~"
    
    show batta normal maniacal
    batta "THEIR LIVES WILL BE LOST AS WELL!!!"
    ...
    batta "Aren't you having fun yet, Darling? Aren't you enjoying {i}bonding{/i} with me over our mutual love of destruction and doom?"
    ...
    hide batta with fastdissolve
    show daisy confused at left with fastdissolve
    daisy "My Lady?"
    
    show daisy suprised
    daisy "My Lady!!! Please say something, what has happened-"
    ...
    show daisy suprised
    daisy "-a bunch of very tiny stakes!! Hang on, My Lady, I'll..."
    ...
    daisy "I'm sorry, are you talking to me??"
    
    candlestein "Well, yeah. With Boss Lady out for the count, doesn't dominion over all of us and everything in the Evil Keep kiiiiinda fall to you?"
    
    show daisy neutral
    daisy "..."
    
    candlestein "And if she doesn't make it, somebody gotta pay those loans cuz I sure as Turbo- Hell can't."
    
    daisy "...of course. Would you mind giving me a moment alone with her?"
    
    candlestein "Sure, whatever."
    ...
    "You think about what You want to be. {i}Who{i} You want to be."
    ...
    "...if you {i}want{i} to become that version of Yourself with Her by your side."
    daisy "..."
    menu:
        ...
        "DO NOTHING":
            ...
            "{i}    She{i} looks almost just like you."
            "A few swapped colors here and there. Smooth, clean metal casing where yours has begin to crack and chip from wear. {i}She{i} acts just like how you used to as well."
            ...
            "Instead, you begin to notice the way {i}her{i} gaze follows you when you enter, or move to leave a room. The way how, for a brief moment, {i}she{i} drops the dumb look of worshipful devotion for {i}her{i} Lady and begins to stare at you with a..."
        ...
        "USE THE DANGEROUS ITEMS" if has_all_dangerous_items():
            ...
            "All while your Mistress saw fit to toil the days away in a tedious cat- and- mouse chase without even a prize to be won. And when things went wrong- {i}when{i}, not if, because they always did- She was sure to find a way to pass the blame to you."
            "Cursing your non- existent involvement in Her {i}otherwise perfect scheme{i} because if She didn't, then She would have to look for that inadequacy within herself."
            ...
            "Some{i}one{i} has been holding you back."
            ...
            show tulong at center with fastdissolve
            tulong "!!!!"
        ...
        "USE THE UPGRADE ITEMS" if has_all_upgrade_items():
            ...
            batta "Oh DAISY, thank the Lady of Night you're alright! I don't... I..."
            
            show daisy suprised
            daisy "M- my Lady, it's-"
            
            batta "I don't know what I would have done if you were hurt!!"
            ...
            batta "And I was {i}wrong{/i} before, Bug, so wrong. Perhaps, no- surely! The wrongest I've ever been!"
            
            batta "You were never broken, DAISY."
            
            daisy "My Lady, where is all this coming from...?"
            ...
            batta "I'm sorry I made you destroy those Holy Relics. I can tell you didn't want to. I shouldn't have made you do it."
            
            batta "But... would it be kind of fucked up if I said-"
            
            show batta normal happy
            batta "-that you looked {i}so damn beautiful{/i} while you were doing it?"
            ...
            show batta normal happy
            batta "A partner. An equal. A soulmate, a lover-"
            ...
            show batta normal happy
            batta "Surely you must want more than that,"
            ...
            show batta normal happy
            batta "Ooo! Did you have something in mind?"
